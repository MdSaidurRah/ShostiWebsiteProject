...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Employee</h4>

    <div class="page-button-area mb-4">
        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createModal"><i class="fa fa-plus-square" aria-hidden="true"></i> New</button>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title fs-5" id="exampleModalLabel">Create New Employee</h5>
    ...
    <div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fs-5" id="exampleModalLabel">View Employee</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control" readonly name="employee_name" id="employee_name" placeholder="employee_name" >
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    <label for="formGroupExampleInput">Employee Name</label>
                                    <input type="text" class="form-control" readonly name="employee_name" id="employee_name" placeholder="Employee name" >
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="formGroupExampleInput">Designation</label>
                                    <input type="text" class="form-control"readonly name="designation" id="designation" placeholder="Designation" >
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="formGroupExampleInput">Contact No</label>
                                    <input type="text" class="form-control" readonly name="contact_no" id="contact_no" placeholder="Contact No" >
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="formGroupExampleInput">Email</label>
                                    <input type="text" class="form-control" readonly  name="email" id="email" placeholder="Email" >
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="formGroupExampleInput">Date of Join</label>
                                    <input type="text" class="form-control" readonly name="date_of_join" id="date_of_join" placeholder="Date of Join" >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="formGroupExampleInput">Employee Status</label>
                                    <select class="form-control" readonly name="employee_status" >
                                        <option value="ACTIVE">Active</option>
                                        <option value="INACTIVE">Inactive</option>
                                    </select>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#objecttablename').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('/employee/get-all-items') }}",
                columns: [
                    ...
                    {data: 'date_of_join', name: 'date_of_join', searchable: true},
                    {data: 'employee_status', name: 'employee_status', searchable: true},
