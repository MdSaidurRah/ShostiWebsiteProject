...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Edit Service</h4>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" required 
                                                       name="service_title" id="service_title" 
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea rows="3" class="mb-3 d-none" name="service_defination"  id="quill-editor-area">{{ $service->service_defination }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            @if($service->cover_photo)
                                                <img src="{{ url($service->cover_photo) }}" 
