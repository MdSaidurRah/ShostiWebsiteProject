...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Promo Video</h4>

    <div class="page-button-area mb-4">
        <a type="button" href="{{ url('/promotional-video/create') }}" class="btn btn-primary btn-sm">
            <i class="fa fa-plus-square" aria-hidden="true"></i> New Promotional Video
        </a>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#pageTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('/get-all/promotional-videos') }}",
                columns: [
