...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Add Site Banner</h4>

    <div class="row">
        <div class="col-xl-12 col-md-12">
            <div class="card table-card">
                <div class="card-header">
                    <h5>Add Site Banner</h5>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <div class="" style="padding: 30px">
                            ...
                            {{-- ✅ Form for update --}}
                            <form action="{{ url('/site-banner/store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control" required 
                                                       name="banner_title" id="banner_title" 
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="banner_category">
                                                    <option value="SITE BANNER" >Site Banner</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="status">Advertisement Status</label>
