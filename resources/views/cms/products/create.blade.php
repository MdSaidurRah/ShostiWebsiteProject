...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Add Product</h4>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea rows="3" class="mb-3 d-none" name="product_defination"  id="quill-editor-area"></textarea>
                                            </div>
                                        </div>
