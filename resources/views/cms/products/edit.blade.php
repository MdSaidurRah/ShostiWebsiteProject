...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Edit Product</h4>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea rows="3" class="mb-3 d-none" name="product_defination"  id="quill-editor-area">{{ $product->product_defination }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group col-md-12">
                                            @if($product->cover_photo)
                                                <img src="{{ url($product->cover_photo) }}" 
