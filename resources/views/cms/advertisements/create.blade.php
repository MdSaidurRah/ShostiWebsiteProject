...
@section('page-content')
    ...
    <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Admin /</span> Add Advertisement</h4>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <div class="" style="padding: 30px">
                            ...
                            {{-- ✅ Form for update --}}
                            <form action="{{ url('/advertisement/store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
