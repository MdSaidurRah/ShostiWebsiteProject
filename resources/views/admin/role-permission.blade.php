...
@section('page-content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12">
                            <div>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#rolePermissionModal">
    ...
    <div class="modal bd-example-modal-lg fade" id="rolePermissionModal" tabindex="-1" role="dialog"
    ...
    <div class="modal bd-example-modal-lg fade" id="roleModal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal bd-example-modal-lg fade" id="permissionModal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
