...
class DataController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('checkPermission')->except(['fetchCourseModule','fetchCourseModuleQuiz']);
    }

    public function fetchCourseModule(Request  $request)
    {
        $data['module']=CourseModule::where('course_id',$request->course_id)->select('id','moduleCategory')->get();
        return response()->json($data);
    }

    public function fetchCourseModuleQuiz(Request  $request)
    {
        $data['quiz']=Quiz::where('module_id',$request->module_id)->select('id','quizCategory')->get();
        return response()->json($data);
    }
